...
This project includes software, plans, documentation, and experimental data related to the measuring apparatus IRMA (Interactive Real-time Measurement of Attention). The system was developed for the laboratory concerts ob the GAPPP project and was used to record and analyze audience responses. GAPPP (http://gappp.net) was a research project (led by Marko Ciciliani) at the University of Music and Performing Arts Graz/Austria from 2017 to 2021. 
...
The measuring apparatus IRMA is designed in modules. 
