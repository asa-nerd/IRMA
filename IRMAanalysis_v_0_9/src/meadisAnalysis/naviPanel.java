...
public class naviPanel {
	...
	naviPanel(Sample _s){
	    ...
	    VisAFAButton.setGraphic(new ImageView("file:gfx/icons/Timeline-1-Button.png"));
	    VisActivityButton.setGraphic(new ImageView("file:gfx/icons/Timeline-2-Button.png"));
	    VisSubActivityButton.setGraphic(new ImageView("file:gfx/icons/Timeline-3-Button.png"));
	    VisSubAttentionButton.setGraphic(new ImageView("file:gfx/icons/Timeline-4-Button.png"));
	    Bookmarks_Button.setGraphic(new ImageView("file:gfx/icons/Timeline-5-Button.png"));
	    Cartesian1dButton.setGraphic(new ImageView("file:gfx/icons/Timeline-6-Button.png"));
	    Cartesian1dAverageButton.setGraphic(new ImageView("file:gfx/icons/Timeline-7-Button.png"));
	    
	    loadVideoButton.setGraphic(new ImageView("file:gfx/icons/loadVideoButton.png"));
	    openVideoWindowButton.setGraphic(new ImageView("file:gfx/icons/openVideoWindowButton.png"));
	    playButton.setGraphic(new ImageView("file:gfx/icons/playButton.png"));
	    pauseButton.setGraphic(new ImageView("file:gfx/icons/pauseButton.png"));
	    stopButton.setGraphic(new ImageView("file:gfx/icons/stopButton.png"));
